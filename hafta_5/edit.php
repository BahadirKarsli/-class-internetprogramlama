...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($ogrenci_no)) {
        ...
        // Öğrenci numarası benzersiz mi kontrol et (kendi kaydı hariç)
        $check_sql = "SELECT id FROM ogrenciler WHERE ogrenci_no = '$ogrenci_no' AND id != $id";
...
<head>
    ...
    <title>Öğrenci Düzenle - Öğrenci Yönetim Sistemi</title>
...
<body>
    <div class="main-layout">
        ...
        <?php endif; ?>
            ...
            <form method="POST" action="edit.php" id="studentForm">
